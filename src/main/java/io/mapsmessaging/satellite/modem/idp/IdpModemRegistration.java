...
package io.mapsmessaging.satellite.modem.idp;
...
import static io.mapsmessaging.satellite.modem.idp.Constants.*;
...
public class IdpModemRegistration extends BaseModemRegistration {
  ...
  protected void registerReceive() {
    ...
    modemResponder.registerHandler("%MGFG", at -> {
      ...
      String b64 = Base64.getEncoder().encodeToString(hit.getData());
      StringBuilder out = new StringBuilder();
      out.append("%MGFG: ")
