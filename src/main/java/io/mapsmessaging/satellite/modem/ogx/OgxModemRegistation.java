...
package io.mapsmessaging.satellite.modem.ogx;

import io.mapsmessaging.satellite.modem.BaseModemRegistration;
import io.mapsmessaging.satellite.modem.ModemResponder;
import io.mapsmessaging.satellite.modem.SentMessageEntry;

import java.util.Base64;
import java.util.concurrent.ConcurrentLinkedQueue;
import java.util.concurrent.atomic.AtomicInteger;

import static io.mapsmessaging.satellite.modem.ogx.OgxSentMessageEntry.*;
...
public class OgxModemRegistation extends BaseModemRegistration {
  ...
  protected void registerReceive() {
    ...
    modemResponder.registerHandler("%MTMG", at -> {
      ...
      String b64 = Base64.getEncoder().encodeToString(hit.data);
  ...
  protected void registerSend() {
    ...
    modemResponder.registerHandler("%MOQS", at -> {
      ...
      ConcurrentLinkedQueue<OgxSentMessageEntry> next = new ConcurrentLinkedQueue<>();
