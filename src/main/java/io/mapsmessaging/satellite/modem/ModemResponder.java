...
package io.mapsmessaging.satellite.modem;

import com.fazecast.jSerialComm.SerialPort;
import io.mapsmessaging.satellite.modem.idp.IdpModemRegistration;
import io.mapsmessaging.satellite.modem.ogx.OgxModemRegistation;
...
import static io.mapsmessaging.satellite.gateway.InmarsatMockServer.getEnvBool;
...
public class ModemResponder implements Runnable {
  ...
  private final BaseModemRegistration baseModem;
  ...
  public ModemResponder( Queue<byte[]> incomingMessages,  Queue<byte[]> outgoingMessages, String deviceName) {
    ...
    if(getEnvBool("OGX", true)) {
      baseModem = new OgxModemRegistation(this);
    }
    else{
      baseModem = new IdpModemRegistration(this);
